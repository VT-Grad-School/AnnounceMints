...
angular.module('Announcemints')
  .controller('NewAnnouncementCtrl', ['$scope', 'Announcement', function ($scope, Announcement) {
    console.log('NewAnnouncementCtrl');
    $scope.announcements = Announcement.all.query([], (results) => {
